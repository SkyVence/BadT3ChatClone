...
export function MarkdownCodeBlock({ node, inline, className, children, ...props }: CodeProps) {
    ...
    return (
        <div className="group relative w-full my-2">
            <div className="relative rounded-md border shadow-sm overflow-hidden">
                {/* Top border with language indicator */}
                <div className="flex items-center justify-between bg-muted px-4 py-1">
                    {language ? (
